...
#     chmod u+x "$desktop/MozillaFirefox.desktop" 2>/dev/null
    ...
    if [ -e "/usr/bin/firefox" -a ! -e "$desktop/firefox.desktop" -a -e "/usr/share/kde4/config/SuSE/default/firefox.desktop" ]; then
          cp /usr/share/kde4/config/SuSE/default/firefox.desktop "$desktop/"
    fi
    chmod u+x "$desktop/firefox.desktop" 2>/dev/null
    
    if [ -e "/usr/bin/libreoffice" -a ! -e "$desktop/libreoffice.desktop" -a -e "/usr/share/kde4/config/SuSE/default/libreoffice.desktop" ]; then
          cp /usr/share/kde4/config/SuSE/default/libreoffice.desktop "$desktop/"
    fi
    chmod u+x "$desktop/libreoffice.desktop" 2>/dev/null
...
#     chmod u+x "$desktop/kinfocenter.desktop" 2>/dev/null
    ...
    mkdir -p "$desktop"
    if [ ! -e "$desktop/.directory" -a -e "/usr/share/kde4/config/SuSE/default/desktop.directory" ]; then
    ...
    mkdir -p "$downloads"
    if [ ! -e "$downloads/.directory" -a -e "/usr/share/kde4/config/SuSE/default/downloads.directory" ]; then
    ...
    mkdir -p "$music"
    if [ ! -e "$music/.directory" -a -e "/usr/share/kde4/config/SuSE/default/music.directory" ]; then
    ...
    mkdir -p "$pictures"
    if [ ! -e "$pictures/.directory" -a -e "/usr/share/kde4/config/SuSE/default/pictures.directory" ]; then
    ...
    mkdir -p "$public"
    if [ ! -e "$public/.directory" -a -e "/usr/share/kde4/config/SuSE/default/public.directory" ]; then
    ...
    mkdir -p "$videos"
    if [ ! -e "$videos/.directory" -a -e "/usr/share/kde4/config/SuSE/default/videos.directory" ]; then
