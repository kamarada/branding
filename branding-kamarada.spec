...
rm %{buildroot}%{_datadir}/calamares/modules/{packages.conf,shellprocess.conf,unpackfs.conf}
install -m0644 {packages.conf,shellprocess.conf,unpackfs.conf} %{buildroot}%{_datadir}/calamares/modules/
cd ..
